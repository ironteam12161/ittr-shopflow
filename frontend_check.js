...
function showView(view,{push=true,replace=false}={}){
 ...
 const moreBtn=document.querySelector(".mobileMoreBtn");if(moreBtn)moreBtn.classList.toggle("active",["approvals","procenter","activityhistory","accounts","completed"].includes(view));
