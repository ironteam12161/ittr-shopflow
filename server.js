...
app.get("/api/build",(req,res)=>res.json({frontendExpected:"24.15.0",backend:"24.15.0",build:"ITTR-24.15.0-INVOICE-WORKSPACE-PARTS-SEARCH-20260914"}));
