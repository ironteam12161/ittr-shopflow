...
check('release package version is 24.24.3', pkg.version === '24.24.3', pkg.version);
check('frontend release is 24.24.3', html.includes("const FRONTEND_VERSION='24.24.3';") || html.includes('const FRONTEND_VERSION="24.24.3"'));
check('backend release is 24.24.3', server.includes('frontendExpected:"24.24.3",backend:"24.24.3"'));
...
check('v24.24.3 route modules use explicit cache-busting version', html.includes('ROUTE_MODULE_VERSION="24.24.3"') && html.includes('routeAsset("/modules/procenter.html")'));
...
check('invoice v24.24.3 layout hardening exists', modulesInvoicesHtml.includes("invoice-v24211-layout-hardening"));
...
check('app shell globally loads invoice workspace CSS', html.includes('/invoice-workspace.css?v=24.24.3'));
...
check('v24.24.3 duplicate merge actions exported from lazy route', fs.readFileSync('public/modules/procenter.js','utf8').includes('window.previewDuplicateMerge = previewDuplicateMerge') && fs.readFileSync('public/modules/procenter.js','utf8').includes('window.commitDuplicateMerge = commitDuplicateMerge'));
