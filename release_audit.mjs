...
check('release package version is 24.23.2', pkg.version === '24.23.2', pkg.version);
check('frontend release is 24.23.2', html.includes("const FRONTEND_VERSION='24.23.2';") || html.includes('const FRONTEND_VERSION="24.23.2"'));
check('backend release is 24.23.2', server.includes('frontendExpected:"24.23.2",backend:"24.23.2"'));
...
check('v24.23.2 route modules use explicit cache-busting version', html.includes('ROUTE_MODULE_VERSION="24.23.2"') && html.includes('routeAsset("/modules/procenter.html")'));
...
check('invoice v24.23.2 layout hardening exists', modulesInvoicesHtml.includes("invoice-v24211-layout-hardening"));
...
check('app shell globally loads invoice workspace CSS', html.includes('/invoice-workspace.css?v=24.23.2'));
...
check('v24.23.2 duplicate merge actions exported from lazy route', fs.readFileSync('public/modules/procenter.js','utf8').includes('window.previewDuplicateMerge = previewDuplicateMerge') && fs.readFileSync('public/modules/procenter.js','utf8').includes('window.commitDuplicateMerge = commitDuplicateMerge'));
