...
check('release package version is 24.21.2', pkg.version === '24.21.2', pkg.version);
check('frontend release is 24.21.2', html.includes("const FRONTEND_VERSION='24.21.2';") || html.includes('const FRONTEND_VERSION="24.21.2"'));
check('backend release is 24.21.2', server.includes('frontendExpected:"24.21.2",backend:"24.21.2"'));
...
check('v24.21.2 route modules use explicit cache-busting version', html.includes('ROUTE_MODULE_VERSION="24.21.2"') && html.includes('routeAsset("/modules/procenter.html")'));
...
check('invoice v24.21.2 layout hardening exists', modulesInvoicesHtml.includes("invoice-v24211-layout-hardening"));
...
check('app shell globally loads invoice workspace CSS', html.includes('/invoice-workspace.css?v=24.21.2'));
