...
check('release package version is 24.22.0', pkg.version === '24.22.0', pkg.version);
check('frontend release is 24.22.0', html.includes("const FRONTEND_VERSION='24.22.0';") || html.includes('const FRONTEND_VERSION="24.22.0"'));
check('backend release is 24.22.0', server.includes('frontendExpected:"24.22.0",backend:"24.22.0"'));
...
check('v24.22.0 route modules use explicit cache-busting version', html.includes('ROUTE_MODULE_VERSION="24.22.0"') && html.includes('routeAsset("/modules/procenter.html")'));
...
check('invoice v24.22.0 layout hardening exists', modulesInvoicesHtml.includes("invoice-v24211-layout-hardening"));
...
check('app shell globally loads invoice workspace CSS', html.includes('/invoice-workspace.css?v=24.22.0'));
